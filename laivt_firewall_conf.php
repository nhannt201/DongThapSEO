...
//--Cau hinh firewall--//
$laivt_fw_conf['max_lockcount']=60;//So lan toi da phat hien dau hieu DDOS va khoa IP do vinh vien 
$laivt_fw_conf['max_connect']=40;//So ket noi toi da dc gioi han boi $laivt_fw_conf['time_limit']
$laivt_fw_conf['time_limit']=20;//Thoi gian dc thuc hien toi da $laivt_fw_conf['max_connect'] ket noi
$laivt_fw_conf['time_wait']=20;//Thoi gian cho de dc mo khoa khi IP bi khoa tam thoi
$laivt_fw_conf['email_admin']='trungnhan21.12@gmail.com';//Email lien lac voi Admin

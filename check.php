...
$domain = str_replace(":8232","",$domain);
if (!filter_var($domain2, FILTER_VALIDATE_URL) === false) {
  $hienan = "hiem";

echo "<ul id=\"Frames\">\n"; 
echo "	<li class=\"Frame\">".$domain." </li>\n"; 
echo "</ul>\n";
...
$my_file = $tenmien.'.txt';
$handle = fopen('datawb/'.$my_file, 'w+') or die('<center>Quay lại sao. Máy chủ đang có lỗi...</center><br/>'); //implicitly creates file
